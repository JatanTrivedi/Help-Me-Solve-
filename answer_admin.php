...
<head>
    ...
    <title>ANSWER ADMIN|Project 2</title>
    ...
    <div class="container">
        <div class="row text-center my-5">
            <div class="col-md-12 my-4 pt-20">
                ...
                <h5>For answer validation</h5>
                <form method="GET">
                    <table class="table">
                        <?php
                        $sql = "SELECT * FROM answer WHERE status = 0";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="valid_answer.php?ab=<?php echo $row['aid']; ?>">
                                        <input type="button" value="Valid" class="btn btn-success btn-md"></a></td>
                                <td><a href="delete_answer.php?did=<?php echo $row['aid']; ?>">
