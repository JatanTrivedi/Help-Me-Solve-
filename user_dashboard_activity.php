...
<body>
  ...
  <div style="margin: 30px; padding-left: 30px;">
    ...
    <table cellpadding="15">
      <tr>
        <td><a href="user_dashboard.php?uid=<?php echo $uid;?>">Profile</a></td>
        <td><a href="user_dashboard_activity.php">Activity</a></td>
      </tr>
    </table>
  </div>
    ...
    <div class="card">
      <div class="card-body">
        <div>
          ...
          {
          ?>
          <span class="text text-danger">You do not have any tags.</span>
          <?php
          }
          if ($qrows>0 && $qrows <= 2) {
          ?>
        ...
        <div>
          ...
          ?>
            <div>
              ...
              <p><span class="text text-danger">You have still not earned any contributor badge.</span></p>
            </div>
          <?php
          }
  ...
  <section style="position: relative; top: 50px; left: 400px; width: 800px;">
    ...
    <div class="card">
      <div class="card-body">
        ...
        {
        ?>
        <span>You still have not asked any questions. <br> Come on! <a href="ask_question.php">ask your doubt now.</a> </span>
        <?php
        }
        else{
        ?>
  ...
  <section style="position: relative; top: 100px; left: 400px; width: 800px;">
    ...
    <div class="card">
      <div class="card-body">
        ...
        {
        ?>
        <span>You still have not answered to any questions. <br> <a href="question_display_page.php">View a few</a> and try to answer them. </span>
        <?php
        }
        else{
        ?>
        <table cellpadding="10" style="font-size: x-large; text-align:justify; text-justify:inter-word;">
          <?php
          $count = 0;
          ...
          <tr>
            ...
            <td><?php echo $count . ".";?>&nbsp;<a href="give_answer_user.php?qid=<?php echo $answer_array['qid'];?>"><?php echo $answer_array['answer'];?></a> </td>
        </tr>
          <?php
          }
          ?>
