...
<html lang="en">
  ...
  <head>
    ...
    <title>PROFILE DISPLAY|Profile Page</title>
  ...
  <div style="margin: 30px; padding-left: 30px;">
    ...
    <table cellpadding="15">
      <tr>
        ...
        <td><a href="display_user_activity.php?uid=<?php echo $uid;?>">Activity</a></td>
      </tr>
    </table>
  </div>
    ...
    <div class="card">
      <div class="card-body">
        <table cellpadding="10">
          <tr>
            <td><?php echo $answer_rows; ?><br><a href="display_user_activity.php?uid=<?php echo $uid;?>">answers</a> </td>
            <td><?php echo $qrows; ?> <br><a href="display_user_activity.php?uid=<?php echo $uid;?>">questions</a></td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <section style="position: relative; top: 130px; left: 80px; width: 250px;">
    ...
    <div class="card">
      <div class="card-body">
        ...
        if ($int_count < 1) {
        ?>
          <span class="text text-danger">This user will select intrests soon.</span> <br>       
          <?php
        } else {
          if ($value1['intrests'] == '') {
          ?>
  ...
  <section style="position: relative; top: 90px; left: 400px; width: 800px;">
    ...
    <div class="card">
      <div class="card-body">
        <!-- based on questions -->
        <div>
          <h5>These tags are recieved based on <?php echo $value1['name']. "'s";?> questions:</h5>
          <?php
          if ($qrows == 0 && $answer_rows == 0) {
          ?>
            <span class="text text-danger"><?php echo $value1['name'];?> has not recieved any badge yet.</span>
          <?php
          }
          if ($qrows > 0 && $qrows <= 2) {
          ?>
          ...
          ?>
            <span class="text text-primary"><?php echo $value1['name'];?> will recieve some of these soon. </span>
          <?php
          }
        ...
        <!-- based on answers -->
        <div>
          <h5>These tags are recieved based on <?php echo $value1['name']. "'s";?> answers:</h5>
          <?php
          if ($qrows == 0 && $answer_rows == 0) {
          ?>
            <span class="text text-danger"><?php echo $value1['name'];?> has not recieved any badge yet.</span>
    ...
    ?>
      <div class="card">
        <div class="card-body">
          ...
          if ($value1['about'] == '') {
          ?>
            Profile is left to be completed by <?php echo $value1['name']. ".";?>
          <?php } else {
            echo $value1['about'];
          }
          ?>
